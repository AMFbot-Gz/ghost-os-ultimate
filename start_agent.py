...
def main():
    ...
    print()
    print("🐝 PICO-RUCHE v5.0.0 — 10 couches Python — Démarrage")
    print(bar)
    ...
    print()
    print(bar)
    print("🐝 PICO-RUCHE v5.0.0 — 10 couches Python — Tableau de bord")
    print(bar)
    ...
    print(f"🐝 {hive_status}  |  Telegram: [{tg}]  |  v5.0.0 — 10 couches Python")
    print(bar)
